...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>We are pleased to confirm that we have received your payment for the social media campaign.</p>
            <p>Your campaign is now active and running. Thank you for your prompt payment.</p>
            <p class="cost">Rs {{ $ad->NRP }}</p>
            <p>If you have any queries or require further assistance, feel free to contact us. Our team is available from 9 AM to 5 PM, Sunday to Friday.</p>
