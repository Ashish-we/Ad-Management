...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><span class="highlight">Your cost amount:</span>Rs {{ $ad->NRP }}</p>
            <p><span class="highlight">You paid:</span>Rs {{ $ad->NRP + $ad->advance }}</p>
            <p><span class="highlight">Overpaid amount:</span>Rs {{ $ad->advance }}</p>
