    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/admin/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Ashish</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('ads_complete.show')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Completed list</p>
                                    </a>
                                </li>
                                <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('ads.summary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Monthly Summary</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('client_summary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>summary</p>
                                    </a>
                                </li>
                                <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('exp.show')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Other Expences</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('invoice.add')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('all_in_one')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All in One</p>
                                    </a>
                                </li>
                                <!-- <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('card.summary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>summary</p>
                                    </a>
                                </li> -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('credit.show')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>list</p>
                                    </a>
                                </li>
                                <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('credit.summary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Monthly summary</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('debit.show')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>list</p>
                                    </a>
                                </li>
                                <li class="nav-item" style="display:  {{ ($is_super_admin['full_or_partial']) ? 'block' : 'none' }}">
                                    <a href="{{route('debit.summary')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Monthly summary</p>
                                    </a>
                                </li>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2021 <a href="https://tukisoft.com.np">Ashish</a>.</strong>
            All rights reserved.
